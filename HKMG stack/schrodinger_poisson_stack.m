function [Vg, N_inv, F_il, F_hk] = schrodinger_poisson_stack(m0,q,eps_sub,eps_il,eps_hk,t_il,t_hk,N_dop,Eg,ni,psi_s,phi_g)
...
F_il = F_s*eps_sub/eps_il;
V_il = F_il*t_il;
F_hk = F_il*eps_il/eps_hk;
V_hk = F_hk*t_hk;
Vg = psi_s + Vfb + V_il + V_hk;
